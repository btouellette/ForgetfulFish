...
- [ ] Pin and document the upgrade cadence for Node, Next.js, Prisma, and Postgres images.
- [ ] Evaluate and fix outdated client behavior after deploys.
- [ ] Decide the room expiry policy for long-idle games once the active gameplay lifecycle is stable.
